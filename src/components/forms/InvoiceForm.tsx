...
function InvoiceLineIncludeRow({
  ...
  const details = [
    ...
    {
      label: "Receiving",
      value: formatCurrency(Number(line.receiving_amount ?? 0)),
    },
    {
      label: "Delivery",
      value: formatCurrency(Number(line.delivery_amount ?? 0)),
    },
    {
      label: "Customer cost",
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <InvoiceSelectedTotals
            ...
            hint="From checked lines. Profit is retail price minus designer cost. Shipping, tax, receiving, delivery, and fees are passed through to the customer and are not deducted."
          />
        </div>
