...
export function LedgerAccountForm({
  ...
  async function handleDelete() {
    ...
    if (
      !confirm(
        `Delete this charge?\n${label}\n\nRelated tax/shipping/receiving/delivery/fee rows on this charge are also deleted. This cannot be undone.`
      )
    ) {
      return;
    }
    ...
    >
      ...
      <p className="text-sm text-slate-600">
        {canEditCoa
          ...
          : canEditPurchaser
            ? "Change who purchased this line. Shipping, receiving, delivery, and payment-fee companions stay with the same purchaser."
